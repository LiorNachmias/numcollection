...
class TestNumCollectionStrategyPairs {


    @BeforeAll
    public static void init() throws UnsortedValuesException {
        // set threshold to make sure all tests will use StrategySet
        NumCollection.setStrategyThreshold(0); // make sure we go for Set
        NumCollection collection = new NumCollection("1");
        assertSame(collection.getStrategyClass(), NumCollectionPairs.class);
    }
